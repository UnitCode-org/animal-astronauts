  ...
  return (
    <section className="z-20 relative max-w-screen-2xl w-full px-8 md:px-16 mt-36">
      <Image
        ...
        width={500}
        height={500}
        className="absolute z-30 -left-56 hidden md:block"
      />
      <Image
        src="/images/decoration/glow.svg"
        alt="glow"
        width={800}
        height={800}
        className="absolute z-30 -right-96 -bottom-56 hidden md:block"
      />
      <Image
      ...
      <p className="text-center max-w-[600px] mx-auto mb-12 lg:mb-24 text-unit-gray-10 text-sm lg:text-base">
        Limited to 360 Visionaries. Join a community of forward-thinkers shaping
        the future. Gain exclusive access to high-level discussions, networking
        events, conferences, and growth opportunities
      </p>
      <div className="flex flex-col lg:flex-row items-center justify-center gap-x-2 mb-20 lg:mr-[240px]">
        ...
        <div className="flex-col items-start max-w-[500px]">
          ...
          <p className="text-unit-gray-10 text-center lg:text-start text-sm lg:text-base">
            You're not just joining a club—you're becoming part of a close-knit
            group of 360 individuals who are redefining what's possible. This is
            your chance to connect with like-minded pioneers, engage in
            high-level conversations, and unlock doors to opportunities that can
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-x-2 mb-20 lg:ml-[240px]">
        <div className="flex flex-col items-center lg:items-end max-w-[500px]">
          ...
          <p className="text-center lg:text-end text-sm lg:text-base text-unit-gray-10">
            To embark on this journey, you'll need to hold $1,000 worth of UNIT
            Tokens on the Unit Network App. These tokens are more than just an
            asset—they are your entry pass into a world where innovation meets
            exclusivity.
          </p>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-x-2 mb-32 lg:mr-[240px]">
        <Image
        ...
        <div className="flex-col items-start max-w-[500px] mt-6 lg:mt-0">
          ...
          <p className="text-center max-w-[600px] mx-auto mb-24 text-unit-gray-10 text-sm lg:text-base">
            ...
            ensuring that our values align, and setting the stage for a fruitful
            partnership within the Astronaut Alliance.
          </p>
        </div>
      </div>
    </section>
